 ...
 *)
function mpg123_init(): cint; cdecl; external LIB_MPG123;

(** Function to close down the mpg123 library.
 *    This function is not thread-safe. Call it exactly once per process, before any other (possibly threaded) work with the library. *)
procedure mpg123_exit(); cdecl; external LIB_MPG123;
...
*)
function mpg123_new(const decoder: pchar; error: pcint): pmpg123_handle; cdecl; external LIB_MPG123;

(** Delete handle, mh is either a valid mpg123 handle or NULL.
 *  \param mh handle
 *)
procedure mpg123_delete(mh: pmpg123_handle); cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_param(mh: pmpg123_handle; _type: mpg123_parms; value: clong; fvalue: cdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_getparam(mh: pmpg123_handle; _type: mpg123_parms; val: pclong; fval: pcdouble): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_feature(const key: mpg123_feature_set): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_plain_strerror(errcode: cint): pchar; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_strerror(mh: pmpg123_handle): pchar; cdecl; external LIB_MPG123;

(** Return the plain errcode intead of a string.
 *  \param mh handle
 *  \return error code recorded in handle or MPG123_BAD_HANDLE
 *)
function mpg123_errcode(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_decoders(): ppchar; cdecl; external LIB_MPG123;

(** Get supported decoder list.
 *  \return NULL-terminated array of the decoders supported by the CPU (plain 8bit ASCII)
 *)
function mpg123_supported_decoders(): ppchar; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_decoder(mh: pmpg123_handle; const decoder_name: pchar): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_current_decoder(mh: pmpg123_handle): pchar; cdecl; external LIB_MPG123;
...
function mpg123_encsize(encoding: cint): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_format_none(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_format_all(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
...
function mpg123_format(mh: pmpg123_handle; rate: clong; channels: cint; encoding: cint): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_open(mh: pmpg123_handle; const path: pchar): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_open_fd(mh: pmpg123_handle; fd: cint): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_open_handle(mh: pmpg123_handle; iohandle: pointer): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_open_feed(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;

(** Closes the source, if libmpg123 opened it.
 *  \param mh handle
 *  \return MPG123_OK on success
 *)
function mpg123_close(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK or error/message code
 *)
function mpg123_framebyframe_next(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
...
function mpg123_framepos(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_tell(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;

(** Returns the frame number that the next read will give you data from.
 *  \param mh handle
 *  \return frame offset or MPG123_ERR (null handle)
 *)
function mpg123_tellframe(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;

(** Returns the current byte offset in the input stream.
 *  \param mh handle
 *  \return byte offset or MPG123_ERR (null handle)
 *)
function mpg123_tell_stream(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_seek(mh: pmpg123_handle; sampleoff: off_t; whence: cint): off_t; cdecl; external LIB_MPG123;
 ...
 *  \return The resulting offset >= 0 or error/message code *)
function mpg123_feedseek(mh: pmpg123_handle; sampleoff: off_t; whence: cint; input_offset: poff_t): off_t; cdecl; external LIB_MPG123;
 ...
 * \param whence one of SEEK_SET, SEEK_CUR or SEEK_END
 * \return The resulting offset >= 0 or error/message code *)
function mpg123_seek_frame(mh: pmpg123_handle; frameoff: off_t; whence: cint): off_t; cdecl; external LIB_MPG123;
...
function mpg123_timeframe(mh: pmpg123_handle; sec: cdouble): off_t; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_position( mh: pmpg123_handle; frame_offset: off_t; buffered_bytes: off_t; current_frame: poff_t; frames_left: poff_t; current_seconds: pcdouble; seconds_left: pcdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_eq(mh: pmpg123_handle; channel: mpg123_channels; band: cint; val: cdouble): cint; cdecl; external LIB_MPG123;
...
function mpg123_geteq(mh: pmpg123_handle; channel: mpg123_channels; band: cint): cdouble; cdecl; external LIB_MPG123;

(** Reset the 32 Band Audio Equalizer settings to flat
 *  \param mh handle
 *  \return MPG123_OK on success
 *)
function mpg123_reset_eq(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_volume(mh: pmpg123_handle; vol: cdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_volume_change(mh: pmpg123_handle; change: cdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_getvolume(mh: pmpg123_handle; base: pcdouble; really: pcdouble; rva_db: pcdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_info(mh: pmpg123_handle; mi: pmpg123_frameinfo): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_scan(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_framelength(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;

(** Return, if possible, the full (expected) length of current track in samples.
 * \param mh handle
 * \return length >= 0 or MPG123_ERR if there is no length guess possible.
 *)
function mpg123_length(mh: pmpg123_handle): off_t; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_set_filesize(mh: pmpg123_handle; size: off_t): cint; cdecl; external LIB_MPG123;

(** Get MPEG frame duration in seconds.
 *  \param mh handle
 *  \return frame duration in seconds, <0 on error
 *)
function mpg123_tpf(mh: pmpg123_handle): cdouble; cdecl; external LIB_MPG123;

(** Get MPEG frame duration in samples.
 *  \param mh handle
 *  \return samples per frame for the most recently parsed frame; <0 on errors
 *)
function mpg123_spf(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123;

(** Get and reset the clip count.
 *  \param mh handle
 *  \return count of clipped samples
 *)
function mpg123_clip(mh: pmpg123_handle): clong; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_getstate(mh: pmpg123_handle; key: mpg123_state; val: pclong; fval: pcdouble): cint; cdecl; external LIB_MPG123;
 ...
 *)
procedure mpg123_init_string(sb: pmpg123_string); cdecl; external LIB_MPG123;

(** Free-up mempory for an existing mpg123_string
 *  \param sb string handle
 *)
procedure mpg123_free_string(sb: pmpg123_string); cdecl; external LIB_MPG123;
 ...
 *  \return 0 on error, 1 on success
 *)
function mpg123_copy_string(from: pmpg123_string; _to: pmpg123_string ): cint; cdecl; external LIB_MPG123;
 ...
 *  \return 0 on error, 1 on success
 *)
function mpg123_add_string(sb: pmpg123_string; const stuff: pchar): cint; cdecl; external LIB_MPG123;
 ...
 *  \return 0 on error, 1 on success
 *)
function mpg123_set_string(sb: pmpg123_string; const stuff: pchar): cint; cdecl; external LIB_MPG123;
 ...
 *  \return 0 on error, 1 on success
 *)
function mpg123_chomp_string(sb: pmpg123_string): cint; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_enc_from_id3(id3_enc_byte: cuchar): mpg123_text_encoding; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_meta_check(mh: pmpg123_handle): cint; cdecl; external LIB_MPG123; (* On error (no valid handle) just 0 is returned. *)

(** Clean up meta data storage (ID3v2 and ICY), freeing memory.
 *  \param mh handle
 *)
procedure mpg123_meta_free(mh: pmpg123_handle); cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_id3(mh: pmpg123_handle; v1: ppmpg123_id3v1; v2: ppmpg123_id3v2): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_icy(mh: pmpg123_handle; icy_meta: ppchar): cint; cdecl; external LIB_MPG123; (* same for ICY meta string *)
...
function mpg123_icy2utf8(const icy_text: pchar): pchar; cdecl; external LIB_MPG123;
 ...
 *)
function mpg123_parnew(mp: pmpg123_pars; const decoder: pchar; error: pcint): pmpg123_handle; cdecl; external LIB_MPG123;

(** Allocate memory for and return a pointer to a new mpg123_pars
 *  \param error error code return address
 *  \return new parameter handle
 *)
function mpg123_new_pars(error: pcint): pmpg123_pars; cdecl; external LIB_MPG123;

(** Delete and free up memory used by a mpg123_pars data structure
 *  \param mp parameter handle
 *)
procedure mpg123_delete_pars(mp: pmpg123_pars); cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_fmt_none(mp: pmpg123_pars): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_fmt_all(mp: pmpg123_pars): cint; cdecl; external LIB_MPG123;
 ...
 * \return MPG123_OK on success
*)
function mpg123_fmt(mp: pmpg123_pars; rate: clong; channels: cint; encodings: cint): cint; cdecl; external LIB_MPG123; (* 0 is good, -1 is error *)
 ...
 *  \return 0 for no support (that includes invalid parameters), MPG123_STEREO,
 *          MPG123_MONO or MPG123_STEREO|MPG123_MONO. *)
function mpg123_fmt_support(mp: pmpg123_pars; rate: clong; encoding: cint): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_par(mp: pmpg123_pars; _type: mpg123_parms; value: clong; fvalue: cdouble): cint; cdecl; external LIB_MPG123;
 ...
 *  \return MPG123_OK on success
 *)
function mpg123_getpar(mp: pmpg123_pars; _type: mpg123_parms; val: pclong; fval: pcdouble): cint; cdecl; external LIB_MPG123;
 ...
 * \return MPG123_OK on success
 *)
function mpg123_replace_reader_handle(mh: pmpg123_handle; r_read: mpg123_readproc; r_lseek: mpg123_seekproc): cint; cdecl; external LIB_MPG123;
